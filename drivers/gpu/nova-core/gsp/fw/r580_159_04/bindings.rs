...
pub const NV_VGPU_MSG_FUNCTION_NUM_FUNCTIONS: _bindgen_ty_2 = 229;
...
pub type NV2080_CTRL_CMD_FB_GET_FB_REGION_SURFACE_MEM_TYPE_FLAG = [u8_; 18usize];
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, MaybeZeroable)]
...
pub struct GspSystemInfo {
    ...
    pub __bindgen_padding_5: [u8; 4usize],
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, MaybeZeroable)]
